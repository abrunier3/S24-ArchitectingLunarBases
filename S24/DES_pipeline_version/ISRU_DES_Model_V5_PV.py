...
def run_scenario(optionsDict):
    ...
    # =========================================================
    # MODIFICATION 7: LOXDeliveryController uses the first plant
    # as the LOX source for simplicity.  Because all plants share
    # the same physical location they could share a common LOX
    # tank; a more advanced model could aggregate across plants.
    # =========================================================
    system.process(LOXDeliveryController(system, plants[0], LOXCargoRover, landingZone, distance=LOX_haul_distance, transportThreshold=transport_threshold))
